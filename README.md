...
[![C++](https://img.shields.io/badge/C%2B%2B-20-blue?logo=c%2B%2B&logoColor=white)](https://isocpp.org)
[![React](https://img.shields.io/badge/React.js-TypeScript-61DAFB?logo=react&logoColor=black)](https://react.dev)
[![MySQL](https://img.shields.io/badge/MySQL-Database-4479A1?logo=mysql&logoColor=white)](https://www.mysql.com)
[![Redis](https://img.shields.io/badge/Redis-Cache-DC382D?logo=redis&logoColor=white)](https://redis.io)
[![MinIO](https://img.shields.io/badge/MinIO-File%20Storage-C72E49?logo=minio&logoColor=white)](https://min.io)
...
**Data / Control Flow**
1. The frontend sends hierarchy, enrollment, authentication, chat, and notification requests over REST/WSS.
2. The custom `epoll` event loop accepts and multiplexes both REST and WebSocket connections asynchronously.
3. Work items (chat messages, announcement broadcasts, notification jobs) are pushed by producers onto a bounded, thread-safe queue.
4. A fixed-size thread pool of consumer workers pops and processes queued items, coordinated via mutexes and condition variables and dispatched according to the active CPU scheduling policy.
5. MySQL persists core relational data with transactions and indexing; Redis caches hot data (sessions, presence, recent messages); MinIO stores uploaded files.
6. A periodic deadlock-detection routine (wait-for graph) and aging counters protect the scheduler's ready queues from deadlock and starvation.
...
2. [Linux `epoll(7)` man page](https://man7.org/linux/man-pages/man7/epoll.7.html)
3. [libpqxx documentation](https://libpqxx.readthedocs.io/)
4. [MySQL documentation](https://www.mysql.com/) (transactions, indexing)
